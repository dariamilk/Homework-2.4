...
public class CalculatorServiceImplParameterizedTest {
    ...
    public void shouldGenerateCorrectSum (Integer num1, Integer num2, Integer expected) {
    ...
    public void shouldGenerateCorrectDecrementing (Integer num1, Integer num2, Integer expected) {
    ...
    public void shouldGenerateCorrectMultiplicity (Integer num1, Integer num2, Integer expected) {
    ...
    public void shouldGenerateCorrectDivision (Integer num1, Integer num2, Double expected) {
    ...
    public static Stream<Arguments> provideParamsForDivisionTest () {
        return Stream.of (
                ...
                Arguments.of(4, -9,-0.4444444444444444)
        );
    }
    @Test
